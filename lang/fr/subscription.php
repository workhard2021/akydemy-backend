...
return [
    ...
    */
    ...
    'teacher-valide-message' => 'Bonjour Cher Formateur, Nous vous informons de l’abonnement du compte :stutian_mail au Module :title (Veuillez Trouver les détails de l’abonnement dans les notifications de votre espace formateur). L’équipe '.config('app.name').' vous remercie de votre professionnalisme',
